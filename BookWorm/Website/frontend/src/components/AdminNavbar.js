    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
      <div className="container">
        ...
        <div className="d-flex align-items-center">
          ...
          <Link to="/bookmanagement" className="btn btn-light me-2">
            <i className="bi bi-book"></i> Books
          </Link>

          <Link to="/buyer-list" className="btn btn-light me-2">
            <i className="bi bi-person"></i> User
          </Link>

          <Link to="/seller-list" className="btn btn-light me-2">
            <i className="bi bi-shop"></i> Seller
          </Link>

          <Link to="/profile" className="btn btn-light">
            <i className="bi bi-person-circle"></i> {user ? user.username : "Profile"}
          </Link>
